...
def get_sprite(pokedex_id, side):
    file_name = "cache/sprites/" + str(pokedex_id) + side + ".png"    
    if not os.path.isfile(file_name):
        # Get image
        pokemon_data = get_data("pokemon", pokedex_id)
        sprite_url = pokemon_data["sprites"][side + "_default"]
        urlretrieve(sprite_url, file_name)
